...
export default function Home() {
  ...
  return (
    <div className="flex-1 bg-gradient-to-b from-[#1a1a1a] to-yeah-bg overflow-y-auto no-scrollbar pb-48 md:pb-32">
      <TopNav />

      <div className="px-4 sm:px-6 lg:px-8 py-5 sm:py-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-white mb-5 sm:mb-6 mt-1 sm:mt-2">Good Evening</h1>
