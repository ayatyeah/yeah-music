  ...
  return (
    <div className="p-8 pb-32">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white">Artist Studio</h1>
          <p className="text-gray-400 mt-1">Manage your releases and monitor infrastructure.</p>
        </div>
        <button
          onClick={() => navigate('/artist/upload')}
          className="bg-yeah-accent text-black px-6 py-2.5 rounded-full font-bold flex items-center gap-2 hover:scale-105 transition-transform"
        >
      ...
      <div className="mt-10 border-2 border-dashed border-gray-700 rounded-2xl p-16 flex flex-col items-center justify-center text-center bg-[#181818]/50 hover:bg-[#181818] transition-colors cursor-pointer group">
